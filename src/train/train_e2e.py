...
if __name__ == '__main__':
    ...
    parser.add_argument('--objective_mode', type=int, default=0, help='')
    ...
    # Added by MX
    parser.add_argument('--cache_dir', type=str, default='/u/scr/xlisali/contrast_LM/transformers/examples/control',
                        help='cache dir')
